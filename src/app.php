...
$jobsImporter = new JobsImporter(SQL_HOST, SQL_USER, SQL_PWD, SQL_DB, RESSOURCES_DIR . $argv[1]);

$filetype = explode('.', $argv[1]);
$filetype = $filetype[count($filetype) - 1];

switch($filetype) {
    case 'xml':
        $count = $jobsImporter->importJobsFromXml();
        break;
    case 'json':
        $count = $jobsImporter->importJobsFromJson();
        break;
    default:
